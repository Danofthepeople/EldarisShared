...
We are using point buy, the reason why is for fairness and balance. You will however you will gain an extra Feat at level 1, granting build flexibility and cooler characters. 

Additionally, we are using the option to customise your origin, meaning you can swap the ASIs that you'd normally get from your race for ones that fit your character, allowing for more species flexibility.
...
- **Flanking** 
	- Provides a +2 to attack rolls instead of advantage.
	- This means that a creature can benefit from both gaining advantage, and tactically positioning themselves.
- **Opportunity Attacks**
...
- **Intelligence Proficiencies**
	- You gain a number of proficiencies equal to your intelligence modifier. 
	- This can be a tool, language or skill proficiency.
- **Fall Damage**
	- The fall damage cap is increased to 1000d6, sudden deceleration is a bitch.
	- Fall damage counts as bludgeoning damage, not true damage.
- **Magic Item Properties**
	- Attuning to an magic item does not tell you it's capabilities. 
	- You must spend time studying the item, using spells or other methods to determine it's abilities.
	- In addition, identifying an items abilities can be difficult, with some abilities being harder to determine than others.
- **[[Injury Rules]]** 
	- If you go down you will have a chance to get injured. Good luck.
- **[[Death Rules]]** 
	- Coming back to life is taken for granted, not anymore.
- **Condition Changes**
	- **Paralyzed**
		- An affected target's speed is halved.
		- All attacks against the creature are made with advantage.
		- Any Attack that hits the creature is a critical hit if the attacker is within 5 feet of the creature.
		- Attacks the target makes have disadvantage.
		- it automatically fails all strength and dexterity based checks or saves.
